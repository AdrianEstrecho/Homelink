...
const categories = [
  { id: uuid(), name: 'Air Conditioners', slug: 'air-conditioners', description: 'Split type, window type, and inverter AC units', image: 'https://images.unsplash.com/photo-1631545806608-20ecc071f657?w=400' },
  ...
  { id: uuid(), name: 'Plumbing', slug: 'plumbing', description: 'Plumbing supplies and fixtures', image: 'https://images.unsplash.com/photo-1607472586893-a037c0a2df62?w=400' },
  ...
  { id: uuid(), name: 'Home Appliances', slug: 'home-appliances', description: 'Essential home appliances', image: 'https://images.unsplash.com/photo-1585659722983-3b344a8a1927?w=400' },
  ...
  { id: uuid(), name: 'Tools', slug: 'tools', description: 'Home improvement tools', image: 'https://images.unsplash.com/photo-1530124566582-a618bc261dc8?w=400' },
];
...
const products = [
  { name: 'Daikin Inverter Split AC 1.5HP', slug: 'daikin-inverter-1-5hp', cat: 'ac-split-type', price: 32999, stock: 25, featured: 1, image: 'https://images.unsplash.com/photo-1631545806608-20ecc071f657?w=600', specs: { brand: 'Daikin', capacity: '1.5 HP', type: 'Split Inverter', energyRating: '5 Star' } },
  ...
  { name: 'Copper Wire 2.0mm (100m roll)', slug: 'copper-wire-2mm', cat: 'electrical', price: 3200, stock: 50, featured: 0, image: 'https://images.unsplash.com/photo-1591698613268-36979a4a8a6c?w=600', specs: { gauge: '2.0mm', length: '100m', material: 'Copper' } },
  { name: 'Kohler Kitchen Faucet Set', slug: 'kohler-faucet-set', cat: 'plumbing', price: 8500, stock: 22, featured: 0, image: 'https://images.unsplash.com/photo-1607472586893-a037c0a2df62?w=600', specs: { brand: 'Kohler', finish: 'Chrome', type: 'Pull-down' } },
  ...
  { name: 'Smart Door Lock with Fingerprint', slug: 'smart-door-lock', cat: 'smart-home', price: 9800, stock: 20, featured: 0, image: 'https://images.unsplash.com/photo-1558009203-9d1d0227d8d4?w=600', specs: { unlock: 'Fingerprint, PIN, App', battery: '8 months' } },
  { name: 'Samsung Refrigerator 2-Door', slug: 'samsung-fridge-2door', cat: 'appliances-refrigerators', price: 28999, stock: 10, featured: 1, image: 'https://images.unsplash.com/photo-1585659722983-3b344a8a1927?w=600', specs: { brand: 'Samsung', capacity: '380L', type: 'No Frost' } },
  { name: 'LG Front Load Washing Machine', slug: 'lg-front-load-washer', cat: 'appliances-washing-machines', price: 32999, stock: 8, featured: 0, image: 'https://images.unsplash.com/photo-1626806819282-2c1dc01a5b0a?w=600', specs: { brand: 'LG', capacity: '8kg', type: 'Inverter Direct Drive' } },
  ...
  { name: 'Bosch Power Drill Kit', slug: 'bosch-drill-kit', cat: 'tools', price: 6500, stock: 25, featured: 0, image: 'https://images.unsplash.com/photo-1530124566582-a618bc261dc8?w=600', specs: { brand: 'Bosch', voltage: '18V', includes: '2 Batteries, Charger' } },
];
...
const galleryItems = [
  { title: 'AC Installation Project', category: 'Air Conditioning', image: 'https://images.unsplash.com/photo-1631545806608-20ecc071f657?w=800' },
  ...
  { title: 'Plumbing Renovation', category: 'Plumbing', image: 'https://images.unsplash.com/photo-1607472586893-a037c0a2df62?w=800' },
];
