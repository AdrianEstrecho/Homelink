...
router.put('/orders/:id/payment-status', authorizeAdminOr('general_staff', 'inventory_clerk'), (req, res) => {
  ...
  logActivity(req, 'order.payment_status_update', 'order', req.params.id, { from: order.payment_status, to: paymentStatus });
